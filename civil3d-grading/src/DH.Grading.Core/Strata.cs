...
public sealed class StrataModel
{
    ...
    /// 지층은 <b>하단 표고</b>를 이어 지형을 따라가지만, 물은 <b>보링공 수위 표고</b>를 이어
    /// 기복이 훨씬 완만해진다. 실측(0907): 지층 격자에서 지반 63.92~126.71m일 때
    /// 지하수위 63.92~118.95m — <b>낮은 쪽은 같고</b>(지표에 붙임) <b>높은 쪽은 7.76m 낮다</b>.</para>
    /// <para>JACK에게 <b>깊이로 따라가게 할지</b> 물었고 <b>지금대로 표고로</b>를 고르셨다.
    /// 수문지질 관례와도 맞다 — 지하수면은 지형을 따르되 <b>훨씬 완만하다</b>.
    /// <b>다시 묻지 말 것</b>: 이것은 결함이 아니다.</para></summary>
