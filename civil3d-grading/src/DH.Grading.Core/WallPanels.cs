...
public static class WallPanels
{
        ...
        System.Func<double, double, int, bool>? keep = null)
    {
        ...
        for (int k = 1; k < rings.Count; k++)
        {
            ...
            // [0805 JACK '엉뚱한 곳에 거대한 쐐기 판넬'] 위 규칙은 **단높이 5m 상한**을
            //   전제로 한다(★v32.57에 상한이 15m로, 판넬 규격이 1.5m로 바뀌었다 — <b>이 옛 경로만 옛 규격</b>이다).
            //   그런데 step은 이웃 두 링의 **평균 Z 차이**라, 구간 옹벽·사면이 섞인 링에서는
