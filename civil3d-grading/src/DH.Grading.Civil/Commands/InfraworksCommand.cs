        ...
        try
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string combineNote = GradingSettings.CombineWallBlocks ? "색깔별 메시 결합(성능)" : "개별 블록";
                    log.AppendLine($"옹벽3D.dwg: 원스톤 {nb}개 + 캡 {nc}개 [{combineNote}] (블록 {GradingSettings.WallBlockW * 1000:F0}×{GradingSettings.WallBlockD * 1000:F0}×{GradingSettings.WallBlockH * 1000:F0}, 캡 두께 {GradingSettings.WallCapT * 1000:F0}, 전체 10mm 하강)");
                }
